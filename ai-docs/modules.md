...
> 状态：V1 模块已实现；第二版模块边界已设计、待用户确认、尚未实现
> 更新日期：2026-08-07

本文件说明目标模块边界。模块被列出不表示对应代码已经存在或完成；实际进度以当前工作树、`progress.md` 和 `task.md` 为准。

> CR-20260807-01 的目标模块边界见第 9 节；第 2 节当前矩阵仍只描述 V1 实现事实，不能据此宣称第二版已完成。
...
第二版代码完成状态以 `task.md`/`progress.md` 为准；本节仅提出待确认的责任和依赖，禁止将设计状态标作 DONE。
